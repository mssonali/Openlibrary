...
import com.sonali.mylibrary.network.BookApiService
...
@ExperimentalCoroutinesApi
    ...
    @get:Rule
        ...
        fun `fetch books from API and return success`() = runBlockingTest {
            ...
            val mockResponse = Response.success(fakeBookList)

            // Mock API Response
           // val thenReturn = `when`(bookApiService.getBookList()).thenReturn(mockResponse)
        ...
        fun `fetch books from API and return empty list`() = runBlockingTest {
           ...
           // val emptyBook = MyBooks() // Make sure MyBooks has default values
